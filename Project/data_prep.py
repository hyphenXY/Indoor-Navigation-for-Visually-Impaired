...
for filename in os.listdir(folder_path):
    if filename.endswith(".csv"):
        ...
        for mac_id in fixed_mac_ids_ground:
            ...
            mac_dataframes[mac_id] = pd.concat(
                [mac_dataframes[mac_id], filtered_df], ignore_index=True
            )

for mac in fixed_mac_ids_ground:
    # print(mac_dataframes[mac])
    columns_to_drop = ["MAC ADDRESS", "RSSI"]  # specify the columns you want to delete
